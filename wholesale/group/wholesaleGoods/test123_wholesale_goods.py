...
def test123():
    ...
    print('test123:进入批发→组→批发管理→批发订单')
    time.sleep(time1)

    # 点击批发订单
    driver.find_element_by_link_text('批发订单').click()
    time.sleep(time2)
    ...
    time.sleep(time1)
    # 选择搜索出来的第一个商品
    driver.find_element_by_xpath('/html/body/div[7]/div/div//ul/li[%s]' % random_number).click()
    time.sleep(time1)
    ...
    input_ZK.send_keys('60')


    # 定位数量输入框
    input_number = driver.find_element_by_xpath(
        '/html/body/div[8]/div/div[2]/div/div[2]/div[2]/div[1]/div/div/div[2]/div/div/div/div/div[2]/div/div/div[2]/div/div/div[2]/div')
    # 鼠标双击选择
    ActionChains(driver).double_click(input_number).perform()
    time.sleep(time2)
    # 输入数量
    driver.find_element_by_xpath(
        '/html/body/div[8]/div/div[2]/div/div[2]/div[2]/div[1]/div/div/div[2]/div/div/div/div/div[2]/div/div/div[1]/div/input').send_keys('1')
    ...
    # 提交发货
    driver.find_element_by_xpath(
        '//*[@id="root"]/section/section/main/div/div[3]/div/div[2]/div/div/div[2]/div/div/div/div/div[2]/div/div[2]/table/tbody/tr[1]/td[15]/a[2]/i').click()
    time.sleep(time1)
    # 抓取结果
