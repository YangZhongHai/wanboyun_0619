...
def test7():
    ...
    # 点击商品管理
    driver.find_element_by_xpath('//*[@id="root"]/section/section/aside/div/ul/li[4]/div[1]/span/span').click()
    time.sleep(time1)
    ...
    time.sleep(time1)
    # 抓取保存结果
    result = driver.find_element_by_xpath('/html/body/div[2]/div/span/div/div/div/span').text
    correct = ('操作成功')
    #判断是否成功
    if result == correct:
    ...
    # 编辑
    driver.find_element_by_xpath(
        '//*[@id="root"]/section/section/main/div/div[3]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[2]/div/div[2]/table/tbody/tr/td[14]/div/a[1]/i').click()
    time.sleep(time2)
    ...
    #
    # #删除
    # driver.find_element_by_xpath('//*[@id="root"]/section/section/main/div/div[3]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div[2]/div/div[2]/table/tbody/tr/td[14]/div/a[2]/i').click()
    # time.sleep(time1)
    # #确认
