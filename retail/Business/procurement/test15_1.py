...
def test15_1():
    ...
    print('test15:进入零售→店铺→采购管理→采购入库')
    # 库存管理
    ...
    # 供应商
    driver.find_element_by_xpath(
        '/html//div/section/section/main/div/div/div[3]/div[2]/div/div/div/div/div[2]/div/div/form/div/div[2]/div/div[2]/div/span/div/div/div').click()
    time.sleep(time2)
    ...
    driver.find_element_by_xpath(
        '/html/body/div[8]/div/div[2]/div/div[2]/div[2]/div[1]/div/div/div[2]/div/div/div/div/div[2]/div/div/div[1]/div/input').send_keys(
        import_number)
    # 确定
    try:
        driver.find_element_by_xpath('/html/body/div[7]/div/div[2]/div/div[2]/div[3]/button[2]').click()
    except:
        driver.find_element_by_xpath('/html/body/div[8]/div/div//ul/li[1]').click()
    time.sleep(time1)
    # 获取进货商品名字
    try:
        ...
        shop_name = driver.find_element_by_xpath(
            '//*[@id="root"]/section/section/main/div/div[3]/div[3]/div[2]/div/div[1]/div[3]/div/div/div/div[2]/div/div/div[2]/div/div[2]/div/div/span/span').text
    ...
    try:
        ...
        driver.find_element_by_xpath('//*[@id="root"]/section/section/main/div/div[3]/div[3]/div[2]/div/div[1]/div[1]/div/div[1]/div/div[2]/div/button[2]').click()
    ...
    # 审核
    driver.find_element_by_xpath(
        '//*[@id="root"]/section/section/main/div/div[3]/div[3]/div[2]/div/div/div[2]/div/div/div/div/div[2]/div[3]/div[2]/div/table/tbody/tr[1]/td/div/a[2]/i').click()
    time.sleep(time1)
    ...
    if result_save1 == correct:
        print(shop_name + ":采购" + import_number + "件,审核成功\n")
    else:
        print(result_save1 + "\n采购退货异常!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
